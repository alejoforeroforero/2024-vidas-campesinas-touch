...
const YT = ({ youtubeVideoId, refYoutubeFx, imgThumbnail, id, vertical = false, mostrarFlechas = true, mostrarHamburguesa = true }) => {
    ...
    const handleOnCerrar = () => {
        ...
        setTimeout(() => {
            ...
            dispatch(establecerMostrarHamburguesa(mostrarHamburguesa));
            video.pauseVideo();
