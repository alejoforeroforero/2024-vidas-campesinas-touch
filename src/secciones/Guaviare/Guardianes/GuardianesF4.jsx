          ...
          <div className="contenido-general">
            <div className="guardianes-f4-interior">
              ...
              <div className="guardianes-f4-frase">
                ...
                <p>
                  En este video, realizado en colaboración con niños y niñas del
                  Raudal del Guayabero, María Fernanda y Juliana nos cuentan del
                  legado que han recibido de sus antepasados, con las pinturas
                  rupestres de su territorio.
                </p>
              </div>
            </div>
          </div>
