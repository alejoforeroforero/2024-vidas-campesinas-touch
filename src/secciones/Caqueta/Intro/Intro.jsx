...
const videoCaquetaM =
  "https://res.cloudinary.com/dhz9jfn78/video/upload/v1716267079/caqueta/home/caqueta_alcwwn.mp4";
...
const Intro = () => {
  ...
  return (
    <div
      ref={contenedorGRef}
      className="seccion caqueta-intro"
            ...
            <div className="caqueta-descripcion">
              ...
              <div className="caqueta-descripcion-p-contenedor">
                {contador == 0 && (
                  <p
                    className={
                      desaparecer ? "caqueta-intro-p1-des" : "caqueta-intro-p1"
                    }
                  >
                    {CaquetaIntro.p1}
                  </p>
